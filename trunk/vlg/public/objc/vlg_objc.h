...
typedef const char *(^peer_name_handler_swf)(peer *p, void *usr_data);
typedef const unsigned int *(^peer_version_handler_swf)(peer *p, void *usr_data);
typedef RetCode(^peer_load_config_handler_swf)(peer *p, int pnum, const char *param, const char *value, void *usr_data);
typedef RetCode(^peer_init_handler_swf)(peer *p, void *usr_data);
typedef RetCode(^peer_starting_handler_swf)(peer *p, void *usr_data);
typedef RetCode(^peer_stopping_handler_swf)(peer *p, void *usr_data);
typedef RetCode(^peer_on_move_running_handler_swf)(peer *p, void *usr_data);
typedef void(^peer_dying_breath_handler_swf)(peer *p, void *usr_data);
typedef RetCode(^peer_on_incoming_connection_handler_swf)(peer *p, shr_incoming_connection *ic, void *usr_data);
...
typedef void(^inco_connection_on_disconnect_handler_swf)(incoming_connection *conn, ConnectivityEventResult con_evt_res, ConnectivityEventType c_evt_type, void *usr_data);
typedef RetCode(^inco_connection_on_incoming_transaction_handler_swf)(incoming_connection *conn, shr_incoming_transaction *itx, void *usr_data);
...
typedef void(^outg_connection_on_connect_handler_swf)(outgoing_connection *oc, ConnectivityEventResult con_evt_res, ConnectivityEventType c_evt_type, void *usr_data);
typedef void(^outg_connection_on_disconnect_handler_swf)(outgoing_connection *oc, ConnectivityEventResult con_evt_res, ConnectivityEventType c_evt_type, void *usr_data);
