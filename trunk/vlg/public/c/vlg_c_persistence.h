...
RetCode persistence_connection_save_nclass(persistence_connection *pconn, const nentity_manager *nem, unsigned int ts_0, unsigned int ts_1, const nclass *in);
RetCode persistence_connection_update_nclass(persistence_connection *pconn, unsigned short key, const nentity_manager *nem, unsigned int ts_0, unsigned int ts_1, const nclass *in);
RetCode persistence_connection_save_or_update_nclass(persistence_connection *pconn, unsigned short key, const nentity_manager *nem, unsigned int ts_0, unsigned int ts_1, const nclass *in);
RetCode persistence_connection_remove_nclass(persistence_connection *pconn, unsigned short key, const nentity_manager *nem, unsigned int ts_0, unsigned int ts_1, PersistenceDeletionMode mode, const nclass *in);
