...
void *nclass_get_field_by_id(nclass *obj, unsigned int field_id);
void *nclass_get_field_by_name(nclass *obj, const char *field_name);
void *nclass_get_field_by_id_index(nclass *obj, unsigned int field_id, unsigned int index);
void *nclass_get_field_by_name_index(nclass *obj, const char *field_name, unsigned int index);
...
char *nclass_get_field_address_by_column_number(nclass *obj, unsigned int plain_idx, const nentity_manager *nem, const member_desc **member_descriptor);
