...
RetCode incoming_connection::await_for_status_reached_or_outdated(ConnectionStatus test,
...
RetCode outgoing_connection::await_for_status_reached_or_outdated(ConnectionStatus test,
                                                                  ConnectionStatus &current,
                                                                  time_t sec,
                                                                  long nsec)
{
