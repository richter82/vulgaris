...
{
    ((__bridge peer_dying_breath_handler_swf)usr_data)(p, usr_data2);
}
...
void inco_connection_on_disconnect_handler_c(incoming_connection *conn,
                                             ...
                                             void *usr_data2)
{
    ((__bridge inco_connection_on_disconnect_handler_swf)usr_data)(conn, con_evt_res, c_evt_type, usr_data2);
}
...
RetCode inco_connection_on_incoming_transaction_handler_c(incoming_connection *conn,
                                                          ...
                                                          void *usr_data2)
{
    return ((__bridge inco_connection_on_incoming_transaction_handler_swf)usr_data)(conn, itx, usr_data2);
}
...
RetCode inco_connection_on_incoming_subscription_handler_c(incoming_connection *conn,
                                                           ...
                                                           void *usr_data2)
{
    return ((__bridge inco_connection_on_incoming_subscription_handler_swf)usr_data)(conn, isbs, usr_data2);
}
...
void inco_connection_set_on_incoming_transaction_handler_swf(incoming_connection *ic,
                                                             ...
                                                             void *usr_data)
{
    inco_connection_set_on_incoming_transaction_handler(ic,
                                                        inco_connection_on_incoming_transaction_handler_c,
...
void inco_connection_set_on_incoming_subscription_handler_swf(incoming_connection *ic,
                                                              ...
                                                              void *usr_data)
{
    inco_connection_set_on_incoming_subscription_handler(ic,
                                                         inco_connection_on_incoming_subscription_handler_c,
                                                         (__bridge_retained void *)hndl,
                                                         usr_data);
}
...
void outg_connection_status_change_c(outgoing_connection *oc,
                                     ...
                                     void *usr_data2)
{
    ((__bridge outg_connection_status_change_swf)usr_data)(oc, status, usr_data2);
}
...
void outg_connection_on_connect_handler_c(outgoing_connection *oc,
                                          ...
                                          void *usr_data2)
{
    ((__bridge outg_connection_on_connect_handler_swf)usr_data)(oc, con_evt_res, c_evt_type, usr_data2);
}
...
void outg_connection_on_disconnect_handler_c(outgoing_connection *oc,
                                             ...
                                             void *usr_data2)
{
    ((__bridge outg_connection_on_disconnect_handler_swf)usr_data)(oc, con_evt_res, c_evt_type, usr_data2);
}
...
void inco_transaction_request_c(incoming_transaction *tx, void *usr_data, void *usr_data2)
{
    ((__bridge inco_transaction_request_swf)usr_data)(tx, usr_data2);
}

void inco_transaction_closure_c(incoming_transaction *tx, void *usr_data, void *usr_data2)
{
