...
void inco_transaction_set_transaction_status_change_handler(incoming_transaction *tx, inco_transaction_status_change handler, void *ud, void *ud2);
void inco_transaction_set_transaction_closure_handler(incoming_transaction *tx, inco_transaction_closure handler, void *ud, void *ud2);
void inco_transaction_set_inco_transaction_request_handler(incoming_transaction *tx, inco_transaction_request handler, void *ud, void *ud2);
...
void outg_transaction_set_transaction_status_change_handler(outgoing_transaction *tx, outg_transaction_status_change handler, void *ud, void *ud2);
void outg_transaction_set_transaction_closure_handler(outgoing_transaction *tx, outg_transaction_closure handler, void *ud, void *ud2);
