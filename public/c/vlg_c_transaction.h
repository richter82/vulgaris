...
typedef void(*inco_transaction_status_change)(incoming_transaction *tx, TransactionStatus status, void *usr_data);
typedef void(*inco_transaction_request)(incoming_transaction *tx, void *usr_data);
typedef void(*inco_transaction_closure)(incoming_transaction *tx, void *usr_data);
...
void inco_transaction_set_transaction_status_change_handler(incoming_transaction *tx, inco_transaction_status_change handler, void *usr_data);
void inco_transaction_set_transaction_closure_handler(incoming_transaction *tx, inco_transaction_closure handler, void *usr_data);
void inco_transaction_set_inco_transaction_request_handler(incoming_transaction *tx, inco_transaction_request handler, void *usr_data);
...
typedef void(*outg_transaction_status_change)(outgoing_transaction *tx, TransactionStatus status, void *usr_data);
typedef void(*outg_transaction_closure)(outgoing_transaction *tx, void *usr_data);
...
void outg_transaction_set_transaction_status_change_handler(outgoing_transaction *tx, outg_transaction_status_change handler, void *usr_data);
void outg_transaction_set_transaction_closure_handler(outgoing_transaction *tx, outg_transaction_closure handler, void *usr_data);
