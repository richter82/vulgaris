...
typedef void(*inco_connection_on_status_change)(incoming_connection *conn, ConnectionStatus status, void *ud, void *ud2);
...
typedef void(*inco_connection_on_releaseable)(incoming_connection *conn, void *ud, void *ud2);
...
void inco_connection_set_on_status_change(incoming_connection *ic, inco_connection_on_status_change hndl);
...
void inco_connection_set_on_disconnect(incoming_connection *ic, inco_connection_on_disconnect hndl);
void inco_connection_set_on_incoming_transaction(incoming_connection *ic, inco_connection_on_incoming_transaction hndl);
void inco_connection_set_on_incoming_subscription(incoming_connection *ic, inco_connection_on_incoming_subscription hndl);
void inco_connection_set_on_destroy(incoming_connection *ic, inco_connection_on_releaseable hndl);
...
typedef void(*outg_connection_on_status_change)(outgoing_connection *oc, ConnectionStatus status, void *ud, void *ud2);
...
void outg_connection_set_on_status_change(outgoing_connection *oc, outg_connection_on_status_change hndl);
...
void outg_connection_set_on_connect(outgoing_connection *oc, outg_connection_on_connect hndl);
void outg_connection_set_on_disconnect(outgoing_connection *oc, outg_connection_on_disconnect hndl);
void outg_connection_set_user_data(outgoing_connection *oc, void *ud, void *ud2);
